...
public class addstock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(177, 177, 231));
        ...
        jLabel7.setText("Search Product By Name");
        ...
        jButton4.setFont(jButton4.getFont().deriveFont(jButton4.getFont().getStyle() | java.awt.Font.BOLD, jButton4.getFont().getSize()+11));
  ...
  String Sales_Id=jTextField3.getText();
        ...
        String Sales_Date= jTextField6.getText();
      
        try{
             Class.forName("com.mysql.jdbc.Driver");
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/java_stock","root","");
             String query = "insert into sale(Sales_Id,Item_Id,Item_name,Quantity,Price,Sales_Date) values('"+Sales_Id+"','"+Item_Id+"','"+Item_name+"','"+Quantity+"','"+Price+"','"+Sales_Date+"')";
